...
```r
fisheries_tidy %>% 
  summarise(n_genera=n_distinct(country))      #There are 203 countries.
```
...
```r
#Theragra chalcogramma, the Alaska pollock had the highest catch total between 2008-2012.
```
...
##    asfis_species_name      catch_total
##    <chr>                         <dbl>
##  1 Engraulis japonicus           18596
##  2 Theragra chalcogramma         18089
##  3 Scomber japonicus             16629
##  4 Osteichthyes                  15466
##  5 Katsuwonus pelamis            15321
##  6 Todarodes pacificus           10946
##  7 Trichiurus lepturus           10187
##  8 Illex argentinus               7279
##  9 Stephanolepis cirrhifer        7041
## 10 Sardinops melanostictus        6823
## # … with 202 more rows
```
