...
```
## here() starts at C:/Users/Timmo/OneDrive/Desktop/BIS15W2023_tpham
```
...
```r
#These data is technically tidy because each variable has its own column, each observation has its own row, and each value has its own cell. This is in the wide format.
```
...
```
## # A tibble: 11 × 2
##    site                    avg_enterococci_cfu_100ml
##    <chr>                                       <dbl>
##  1 Bondi Beach                                  18.8
##  2 Bronte Beach                                 31.4
...
```r
#I respectfully disagree that this is easier to read T_T 
```
